...
# notification = table.find(string = re.compile('2/14/22'))
# print(notification)
...
# notification = table.find(string = re.compile('March 8, 2022'))
# print(notification)
...
# soup = bs(r.content, features="lxml")
# table = soup.find('ul', attrs={'class': "jcc-news-listing__items"})
# notification = table.find(string = re.compile('April 20, 2021'))
# print(notification)
...
# notification = table.find(string = re.compile('March 2, 2022'))
# print(notification)
...
# soup = bs(r.content, features="lxml")
# table = soup.find('ul', attrs={'class': "jcc-news-listing__items"})
# notification = table.find(string = re.compile('January 27, 2022'))
# print(notification)
...
# soup = bs(r.content, features="lxml")
# table = soup.find('ul', attrs={'class': "jcc-news-listing__items"})
# notification = table.find(string = re.compile('November 22, 2021'))
# print(notification)
...
# soup = bs(r.content, features="lxml")
# table = soup.find('ul', attrs={'class': "jcc-news-listing__items"})
# notification = table.find(string = re.compile('February 16, 2022'))
# print(notification)
...
# soup = bs(r.content, features="lxml")
# table = soup.find('ul', attrs={'class': "jcc-news-listing__items"})
# notification = table.find(string = re.compile('June 24, 2021'))
# print(notification)
