...
GRASS = scale_image(pygame.image.load("Racing_Game/Machine_Learning_Sim/images/grass.jpg"), 1.7)
TRACK = pygame.image.load("Racing_Game/Machine_Learning_Sim/images/my_track.png")
TRACK_BORDER = pygame.image.load("Racing_Game/Machine_Learning_Sim/images/my_track_border.png")

FINISH_LINE = pygame.image.load("Racing_Game/Machine_Learning_Sim/images/finish_line.png")
...
'''Cars Images'''
PLAYER_CAR = scale_image(pygame.image.load("Racing_Game/Machine_Learning_Sim/images/convertable_car.png"), 0.75)
CPU_CAR = scale_image(pygame.image.load("Racing_Game/Machine_Learning_Sim/images/cpu_convertable_car.png"), 0.75)
